...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { content: @empresa.content, name: @empresa.name, nreclamos: @empresa.nreclamos } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { content: @empresa.content, name: @empresa.name, nreclamos: @empresa.nreclamos } }
